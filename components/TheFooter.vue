<template>
	...
	>
		...
		<NuxtLink class="flex flex-col items-center" to="/search">
			<span>
				<svg
					xmlns="http://www.w3.org/2000/svg"
					viewBox="0 0 24 24"
		...
		<NuxtLink class="flex flex-col items-center" to="/library">
			<span>
				<svg
					xmlns="http://www.w3.org/2000/svg"
					viewBox="0 0 24 24"
		...
		<NuxtLink class="flex flex-col items-center" to="/account">
			<span>
				<svg
					xmlns="http://www.w3.org/2000/svg"
					viewBox="0 0 24 24"
